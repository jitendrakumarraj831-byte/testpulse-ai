...
/** Unified dynamic gateway: logged-out visitors get exactly two entry
 * points (Student Login / Admin Login), a signed-in student lands
 * directly on a homepage built entirely from their own real data
 * (schedule, homework, streak, Exam Arena), and a signed-in admin lands
 * on a homepage built entirely from institute-management data (fee
 * ledger, attendance, student directory, exam deployment) — deliberately
 * a different, narrower slice than the fuller analytics view at
 * /admin/dashboard. Each branch renders with only its own chrome
